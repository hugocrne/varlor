...
#### A. Workflows / Automations

- [ ] User can define:
  - [ ] "If such anomaly is detected with such criticality level, then..."
  - [ ] "If such KPI exceeds threshold, send alert / create task / call internal API"

- [ ] Integration:
  - [ ] Webhooks to client systems
  - [ ] Integrations with ticketing tools
  - [ ] Internal script triggering

#### B. Real-Time (optional depending on target)

- [ ] Streaming ingestion:
  - [ ] Kafka / MQTT / other flows
...
- [ ] AI helps to:
  - [ ] Build ontology ("I see Customer/Order type patterns...")
  - [ ] Suggest analysis axes ("you should look at data from this angle...")
  - [ ] Assist in workflow creation ("if you want to monitor X, here's a typical workflow...")

- [ ] AI becomes a **true Varlor copilot**

#### E. Marketplace / Business Packs
...
- [ ] These packs contain:
  - [ ] Basic business ontology
  - [ ] Typical analysis axes
  - [ ] Standard reports
  - [ ] Anomaly rules
...
- Varlor is no longer "a data analysis tool"
