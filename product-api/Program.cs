...
var jwtKey = jwtSection["Key"] ?? throw new InvalidOperationException("JWT secret key est introuvable dans la configuration.");
var jwtIssuer = jwtSection["Issuer"] ?? throw new InvalidOperationException("JWT issuer est introuvable dans la configuration.");
var jwtAudience = jwtSection["Audience"] ?? throw new InvalidOperationException("JWT audience est introuvable dans la configuration.");
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("StandardMemberAccess", policy => policy.RequireRole("OWNER", "ADMIN", "MEMBER"));
    options.AddPolicy("ServiceDeskAccess", policy => policy.RequireRole("OWNER", "ADMIN", "SERVICE"));
});
